...
export default function ContentComponent({ course, disable, onSectionPress, navigation, disableSurvey, continueVideo, isCourseScreen, setReload, reload, percentage }) {
